...
export default function Note (props) {
    ...
    return (
        <Cover>
            ...
            style={{width:"554px", height:"56px", paddingLeft:"1rem", borderRadius:"6px", border:"1px, solid, gray", margin:"1.5rem 0", backgroundColor:"#FAF7F2"}}/>
            ...
            style={{width:"554px", height:"56px", paddingLeft:"1rem", borderRadius:"6px", border:"1px, solid, gray", marginTop:"1.5rem", backgroundColor:"#FAF7F2"}}/>    
